...
pub const __clang_version__: &'static [u8; 30usize] = b"12.0.1 (Fedora 12.0.1-3.fc35)\0";
...
pub const __VERSION__: &'static [u8; 36usize] = b"Clang 12.0.1 (Fedora 12.0.1-3.fc35)\0";
...
extern "C" {
    pub fn res_hnok(arg1: *const ::std::os::raw::c_char) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn res_ownok(arg1: *const ::std::os::raw::c_char) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn res_mailok(arg1: *const ::std::os::raw::c_char) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn res_dnok(arg1: *const ::std::os::raw::c_char) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn __sym_ston(
        arg1: *const res_sym,
